...
open_quizz_db_data = (
    ...
    ("Bande dessinnée", "Tintin", "https://www.kiwimeeeeeeeee.com/oqdb/files/2124627384/OpenQuizzDB_124/openquizzdb_124.json"),
...
def generate_json_file(categorie, titre, url):
    ...
    try:
        ...
        try:
            ...
            print("Exception pour l'url: " + url + "- Quesitonnaire : " + titre)
